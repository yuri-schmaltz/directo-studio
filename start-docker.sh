...
#
# This is the original "make start" flow, preserved for users who already
# have Docker set up. The default `./start.sh` is now the local-mode
# (no-Docker) bootstrapper — use this script if you specifically want the
# Docker path.
#
set -euo pipefail
