...
export default function StyleBiblePage() {
  // List endpoint returns metadata summaries (no arrays)
  ...
  // When user clicks a saved bible, fetch its full data
  const selectBible = useCallback(async (id: string) => {
    ...
    try {
      ...
      // Backend returns characters/environments/directives as arrays from to_dict()
      setLocalBible({
        ...full,
